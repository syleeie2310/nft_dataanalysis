...
over_3 = nfts_merge2['owner_cnts'] >= 3

over_3 = nfts_merge2[over_3]

over_3.head(10)

# COMMAND ----------

over_5 = nfts_merge2['owner_cnts'] >= 5

over_5 = nfts_merge2[over_5]
...
Crypto_j = over_5['name_x'] == 'CryptoKitties'

Crypto_k = over_5[Crypto_j]
...
Crypto_j3 = over_3['name_x'] == 'CryptoKitties'

Crypto_k3 = over_3[Crypto_j3]
