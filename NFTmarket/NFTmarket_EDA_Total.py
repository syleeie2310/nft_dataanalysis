...
# display(totalM_median['2017':'2017']) # 연도별로 본다. 연도별테이블로 추후 서머리
...
series = total['all_average_usd']
train = total.loc[:'2022-1','all_average_usd']
test = total.loc['2022-2','all_average_usd']

# COMMAND ----------

# MAGIC %md
# MAGIC ## 정상화 : 자기 상관 함수(ACF, PACF)
...
autoCorrelationF(total, 'average_usd') #raw df, feature
